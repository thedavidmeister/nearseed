...
clojure.test.check.quick_check.cljs$core$IFn$_invoke$arity$variadic = (function (num_tests,property,p__9552){
var map__9553 = p__9552;
var map__9553__$1 = ((((!((map__9553 == null)))?(((((map__9553.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9553.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__9553):map__9553);
var seed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9553__$1,cljs.core.cst$kw$seed);
var max_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__9553__$1,cljs.core.cst$kw$max_DASH_size,(200));
var vec__9555 = clojure.test.check.make_rng(seed);
var created_seed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9555,(0),null);
var rng = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9555,(1),null);
...
var vec__9558 = size_seq__$1;
var seq__9559 = cljs.core.seq(vec__9558);
var first__9560 = cljs.core.first(seq__9559);
var seq__9559__$1 = cljs.core.next(seq__9559);
var size = first__9560;
var rest_size_seq = seq__9559__$1;
var vec__9561 = clojure.test.check.random.split(rstate);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9561,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9561,(1),null);
...
var G__9567 = (so_far + (1));
var G__9568 = rest_size_seq;
var G__9569 = r2;
so_far = G__9567;
size_seq__$1 = G__9568;
rstate = G__9569;
continue;
} else {
...
/** @this {Function} */
clojure.test.check.quick_check.cljs$lang$applyTo = (function (seq9549){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9550,G__9551,seq9549__$2);
});
...
var vec__9570 = nodes;
var seq__9571 = cljs.core.seq(vec__9570);
var first__9572 = cljs.core.first(seq__9571);
var seq__9571__$1 = cljs.core.next(seq__9571);
var head = first__9572;
var tail = seq__9571__$1;
var result = cljs.core.cst$kw$result.cljs$core$IFn$_invoke$arity$1(clojure.test.check.rose_tree.root(head));
if(cljs.core.truth_(clojure.test.check.not_falsey_or_exception_QMARK_(result))){
var G__9573 = tail;
var G__9574 = current_smallest;
...
var G__9581 = tail;
var G__9582 = clojure.test.check.rose_tree.root(head);
var G__9583 = (total_nodes_visited + (1));
var G__9584 = depth;
nodes = G__9581;
current_smallest = G__9582;
total_nodes_visited = G__9583;
depth = G__9584;
continue;
}
}
